...
Version  : 5.107.0
Release  : 70
URL      : https://download.kde.org/stable/frameworks/5.107/kdbusaddons-5.107.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.107/kdbusaddons-5.107.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.107/kdbusaddons-5.107.0.tar.xz.sig
...
%prep
%setup -q -n kdbusaddons-5.107.0
cd %{_builddir}/kdbusaddons-5.107.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686498223
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5DBusAddons.so.5.107.0
/usr/lib64/libKF5DBusAddons.so.5
/usr/lib64/libKF5DBusAddons.so.5.107.0
