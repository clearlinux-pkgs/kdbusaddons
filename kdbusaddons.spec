...
Version  : 6.13.0
Release  : 99
URL      : https://download.kde.org/stable/frameworks/6.13/kdbusaddons-6.13.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.13/kdbusaddons-6.13.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.13/kdbusaddons-6.13.0.tar.xz.sig
...
%setup -q -n kdbusaddons-6.13.0
cd %{_builddir}/kdbusaddons-6.13.0
pushd ..
cp -a kdbusaddons-6.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744644274
mkdir -p clr-build
pushd clr-build
...
/usr/share/locale/he/LC_MESSAGES/kdbusaddons6_qt.qm
...
/usr/share/locale/ta/LC_MESSAGES/kdbusaddons6_qt.qm
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6DBusAddons.so.6.13.0
/usr/lib64/libKF6DBusAddons.so.6
/usr/lib64/libKF6DBusAddons.so.6.13.0
