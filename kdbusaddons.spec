...
Version  : 6.7.0
Release  : 93
URL      : https://download.kde.org/stable/frameworks/6.7/kdbusaddons-6.7.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.7/kdbusaddons-6.7.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.7/kdbusaddons-6.7.0.tar.xz.sig
...
%setup -q -n kdbusaddons-6.7.0
cd %{_builddir}/kdbusaddons-6.7.0
pushd ..
cp -a kdbusaddons-6.7.0 buildavx2
popd
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6DBusAddons.so.6.7.0
/usr/lib64/libKF6DBusAddons.so.6
/usr/lib64/libKF6DBusAddons.so.6.7.0
