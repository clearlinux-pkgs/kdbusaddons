...
Version  : 6.9.0
Release  : 95
URL      : https://download.kde.org/stable/frameworks/6.9/kdbusaddons-6.9.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.9/kdbusaddons-6.9.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.9/kdbusaddons-6.9.0.tar.xz.sig
...
%setup -q -n kdbusaddons-6.9.0
cd %{_builddir}/kdbusaddons-6.9.0
pushd ..
cp -a kdbusaddons-6.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735161854
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6DBusAddons.so.6.9.0
/usr/lib64/libKF6DBusAddons.so.6
/usr/lib64/libKF6DBusAddons.so.6.9.0
